...
DEFAULT_CONFIG = os.path.join(ROOT, "config", "experiments", "paas4_qwen.json")
...
def main():
    ...
    ap.add_argument("--images", default=os.path.join(ROOT, "images", "0034.jpg"), help="image file path(s)")
